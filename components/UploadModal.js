            ...
            {open && (
                ...
                >
                    <div className='flex flex-col justify-center items-center h-[100%]'>
                        {selectedFile ? (
                            <img onClick={() => setSelectedFile
                            (null)} className='w-full max-h-[250px] object-cover cursor-pointer' src={selectedFile}/>
                        ) : (
                            <CameraIcon onClick={() => filePickerRef.current.click()}
                                className='cursor-pointer h-14 bg-rose-500 p-2 rounded-full border-2 text-white'
                            />
